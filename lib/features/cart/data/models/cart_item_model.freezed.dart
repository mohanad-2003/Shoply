...
mixin _$CartItemModel {
 ...
 String get id; String get productId; String get name; String get imagePath; double get price; int get quantity; String? get color; String? get size;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,productId,name,imagePath,price,quantity,color,size);

@override
String toString() {
  return 'CartItemModel(id: $id, productId: $productId, name: $name, imagePath: $imagePath, price: $price, quantity: $quantity, color: $color, size: $size)';
}
...
@useResult
$Res call({
 String id, String productId, String name, String imagePath, double price, int quantity, String? color, String? size
});
...
/// Create a copy of CartItemModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? productId = null,Object? name = null,Object? imagePath = null,Object? price = null,Object? quantity = null,Object? color = freezed,Object? size = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String productId,  String name,  String imagePath,  double price,  int quantity,  String? color,  String? size)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartItemModel() when $default != null:
return $default(_that.id,_that.productId,_that.name,_that.imagePath,_that.price,_that.quantity,_that.color,_that.size);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String productId,  String name,  String imagePath,  double price,  int quantity,  String? color,  String? size)  $default,) {final _that = this;
switch (_that) {
case _CartItemModel():
return $default(_that.id,_that.productId,_that.name,_that.imagePath,_that.price,_that.quantity,_that.color,_that.size);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String productId,  String name,  String imagePath,  double price,  int quantity,  String? color,  String? size)?  $default,) {final _that = this;
switch (_that) {
case _CartItemModel() when $default != null:
return $default(_that.id,_that.productId,_that.name,_that.imagePath,_that.price,_that.quantity,_that.color,_that.size);case _:
  return null;
...
class _CartItemModel extends CartItemModel {
  const _CartItemModel({required this.id, required this.productId, required this.name, required this.imagePath, required this.price, required this.quantity, this.color, this.size}): super._();
...
/// Create a copy of CartItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? productId = null,Object? name = null,Object? imagePath = null,Object? price = null,Object? quantity = null,Object? color = freezed,Object? size = freezed,}) {
